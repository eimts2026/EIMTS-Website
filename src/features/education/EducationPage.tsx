...
export default function EducationPage() {
  return <main id="main">
    <PageHero eyebrow="Emerald Isle Education" title="Study abroad with someone in your corner." description="Turn your study-abroad ambition into a clear plan with personal guidance from consultation to arrival." />
