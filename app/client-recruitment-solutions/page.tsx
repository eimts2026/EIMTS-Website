...
export default function EmployerPage() {
  return <main id="main">
    <PageHero eyebrow="Client recruitment solutions" title="Leave Your Recruitment Worries To Us" description="We provide a dependable international talent pipeline, from workforce planning and screening through documentation and deployment." />
